...
import "./interface/IMonfiRouter.sol";
import "./interface/IAdapter.sol";
import "./interface/IERC20.sol";
import "./interface/IWETH.sol";
import "./lib/SafeERC20.sol";
import "./lib/Maintainable.sol";
import "./lib/MonfiViewUtils.sol";
import "./lib/Recoverable.sol";
import "./lib/SafeERC20.sol";

contract MonfiRouter is Maintainable, Recoverable, IMonfiRouter {
    using SafeERC20 for IERC20;
    using OfferUtils for Offer;

    address public immutable WNATIVE;
    address public constant NATIVE = address(0);
    string public constant NAME = "MonfiRouter";
    uint256 public constant FEE_DENOMINATOR = 1e4;
    uint256 public MIN_FEE = 30;
    ...
    function _applyFee(
        ...
        require(_fee >= MIN_FEE, "MonfiRouter: Insufficient fee");
    ...
    function _swapNoSplit(
        ...
        require(
            ...
            "MonfiRouter: Insufficient output amount"
        );
        for (uint256 i = 0; i < _trade.adapters.length; i++) {
    ...
    function swapNoSplitFromNative(
        ...
        require(
            ...
            "MonfiRouter: Path needs to begin with WETH"
        );
    ...
    function swapNoSplitToNative(
        ...
        require(
            ...
            "MonfiRouter: Path needs to end with WETH"
        );
    ...
    function risks() external pure returns (string memory) {
        return
            "Monfi router contract is yet to be audited, so use at your own risk- Dluguhs frpphq";
    }
}
